...
<head>
  ...
  <title>Dalex Cargo | Suivi de paiement des Conteneurs</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="../../index2.html" class="logo" style="background-color: #58a75b;">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>D</b>C</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Dalex</b> Cargo</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="https://adminlte.io">Ab'solutionsTech</a>.</strong> All rights
    reserved.
  </footer>
