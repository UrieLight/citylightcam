                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <?php
                            $get_line_price_unit = "SELECT prix_unitaire FROM ligne ORDER BY date DESC LIMIT 1";
                      ...
                      <td>
                        <div class="form-group">
                          ...
                          <br/><small><i id="id_prix_unitaire" value="<?= $prix_unitaire; ?>">*Unitaire: <?= $prix_unitaire; ?> FCFA</i></small>
                        </div>
                      </td>
                    </tr>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#id_cubage').on('change', function(c){
                //console.log('Montant changed');
                var $id_prix_unitaire = $('#id_prix_unitaire').attr("value");
                console.log('id_prix_unitaire: '+$id_prix_unitaire);
                var $prix_tot = $('#id_cubage').val() * $id_prix_unitaire;//350000;
